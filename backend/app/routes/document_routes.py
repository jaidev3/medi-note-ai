...
async def upload_document(
    ...
    """
    Upload document file directly to server and store in S3.
    ...
    Note:
        ...
        The file is uploaded directly to S3 and optionally processed for text extraction and SOAP generation.
    """
...
async def process_document(
    ...
    Note:
        This endpoint should be called after the document has been successfully uploaded to S3.
...
async def delete_document(
    document_id: uuid.UUID = Path(..., description="Document ID"),
    delete_from_s3: bool = Query(True, description="Whether to delete from S3 storage"),
    ...
    Args:
        document_id: Document UUID
        delete_from_s3: Whether to delete the file from S3 storage
    ...
    Note:
        This performs a soft delete in the database and optionally removes the file from S3.
    """
