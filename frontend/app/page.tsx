    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">MediNote AI</h1>
            </div>
      ...
      <div className="relative min-h-screen">
        ...
        <div className="absolute inset-0 z-0">
          <Spline scene="https://prod.spline.design/3PCJSb5JpR7srUCd/scene.splinecode" />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600">
                Automatically generate comprehensive SOAP notes from patient
                conversations with industry-specific terminology recognition.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600">
                Ask natural language questions about patient records and get
                instant, accurate answers from your documentation.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600">
                Process conversation transcripts in real-time and generate SOAP
                notes with minimal delay.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600">
                Track documentation efficiency and gain insights into patient
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600">
                ...
                systems for smooth workflow integration.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-gray-900">
                      Save 70% Time on Documentation
                    </h3>
                    <p className="text-gray-600 mt-1">
                      Focus on patient care instead of paperwork with automated
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      Trained specifically on hearing care terminology and
                      clinical workflows.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      More time with patients leads to better outcomes and
                      higher satisfaction.
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-6">
                Join hundreds of hearing care professionals who have already
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See what our users have to say about MediNote AI
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                "MediNote AI has revolutionized how I document patient visits. I
                can now focus entirely on patient care while the AI handles the
                paperwork."
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                "The accuracy of the SOAP notes is impressive. It understands
                our terminology perfectly and saves me hours every week."
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                "The HIPAA compliance and security features give me peace of
                mind. The integration with our EHR system is seamless."
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center mb-4">
                <h3 className="text-2xl font-bold text-white !text-white">
                  MediNote AI
                </h3>
              </div>
              <p className="text-gray-300 !text-gray-300 mb-6 leading-relaxed">
                AI-powered SOAP note generation designed specifically for
                hearing care professionals. Streamline your documentation
                workflow and focus on what matters most - patient care.
              </p>
            ...
            {/* Product Links */}
            <div>
              <h4 className="text-lg font-semibold text-white !text-white mb-4">
                Product
              </h4>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <h4 className="text-lg font-semibold text-white !text-white mb-2">
                  Stay Updated
                </h4>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="text-gray-300 !text-gray-300 text-sm mb-4 md:mb-0">
                <p>
                  &copy; 2025 MediNote AI. All rights reserved. | HIPAA
